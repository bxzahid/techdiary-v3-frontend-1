<template>
  <Card>
    <h1 class="pb-2 text-3xl uppercase border-b">Techdiary Typography</h1>
    <!-- prose-sm prose sm:prose lg:prose-lg xl:prose-2xl -->
    <div class="prose prose-lg prose-paste max-w-none">
      <p class="lead">
