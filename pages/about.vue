<template>
  <div>
    <div class="bg-gray-800 h-[65vh] flex items-center">
      <div
        ...
        <div class="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div class="flex flex-col mb-16 sm:text-center sm:mb-0">
            ...
            <div>
              <a
                href="/"
                class="inline-flex items-center justify-center h-12 px-6 font-semibold tracking-wide text-white transition duration-200 bg-gray-700 rounded shadow-md focus:shadow-outline focus:outline-none"
              >
                যুক্ত হোন
              </a>
            </div>
        ...
        <div class="grid gap-12 row-gap-8 lg:grid-cols-2">
          <div class="grid gap-12 row-gap-5 md:grid-cols-2">
            <div class="relative">
              ...
              <div class="relative">
                <div
                  class="flex items-center justify-center w-10 h-10 mb-3 rounded-full bg-teal-accent-400"
                >
                  <svg
