<template>
  <div class="mt-5">
    ...
    <a
      class="flex items-center space-x-2 text-sm font-semibold text-gray-500"
    ...
    >
      ...
      <span class="Footer___StyledSpan-sc-9d26d5-7 fKAHWs">Bug পেয়েছেন?</span>
    </a>
    ...
    <div class="mt-2">
      ...
      >
        <img
          ...
          class="Footer___StyledImg-sc-9d26d5-10 epoOPN"
        />
