  ...
  <aside class='col-span-12 mb-5 md:mb-0 md:col-span-3' v-if='user'>
    ...
    <div class="mt-5">
      ...
      <div class="flex space-x-2">
        ...
        <a target='_blank' :href='user.social_links.behance' v-if='user.social_links && user.social_links.behance'>
          <svg xmlns='http://www.w3.org/2000/svg' class='w-5 h-5 text-gray-800 fill-current dark:text-gray-400'
               viewBox='0 0 24 24'>
            <path
        ...
        <a target='_blank' :href='user.social_links.dribbble' v-if='user.social_links && user.social_links.dribbble'>
          <svg xmlns='http://www.w3.org/2000/svg' class='w-5 h-5 text-gray-800 fill-current dark:text-gray-400'
               viewBox='0 0 24 24'>
            <path
        ...
        <a target='_blank' :href='user.social_links.twitch' v-if='user.social_links && user.social_links.twitch'>
          <svg xmlns='http://www.w3.org/2000/svg' class='w-5 h-5 text-gray-800 fill-current dark:text-gray-400'
               viewBox='0 0 24 24'>
            <path
